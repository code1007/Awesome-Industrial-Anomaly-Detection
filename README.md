...
|[CD-PCB](https://github.com/Scientific-Computing-Lab/ChangeChip)|![image](https://github.com/YAOSL98/Awesome-Industrial-Anomaly-Detection/blob/main/CD-PCB.png)|一个包含 20 对 PCB 图像的小型数据集，其中标注了它们之间的变化。该数据集旨在评估 PCB 检查领域的变化检测算法。2021年提出，Bounding box标注，RGB synthetic|
